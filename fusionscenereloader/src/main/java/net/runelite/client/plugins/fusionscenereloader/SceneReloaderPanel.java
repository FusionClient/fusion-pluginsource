...
public class SceneReloaderPanel extends PluginPanel {
    ...
    @Inject
    SceneReloaderPanel(Client client, ClientThread clientThread, ChatMessageManager chatMessageManager, SceneReloaderConfig config)
    {
        this.client = client;
