...
public class HydraExtraOverlay extends Overlay {
    ...
    public Dimension render(Graphics2D graphics) {
        if(plugin.inHydraInstance) {
            ...
            if (config.lightningHighlight() != HydraConfig.LightningMode.OFF && plugin.getHydra() != null) {
            ...
            if (config.ventTicks() && plugin.ventTicks > 0 && this.client.isInInstancedRegion()) {
